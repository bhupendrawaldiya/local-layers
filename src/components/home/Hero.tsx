          ...
          <div className="max-w-2xl mx-auto mt-8">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-32 py-4 rounded-full border border-gray-200 shadow-sm 
                         focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary
                         transition-all duration-200 text-lg bg-white/80 backdrop-blur-sm hover:bg-white"
                value={searchTerm}
